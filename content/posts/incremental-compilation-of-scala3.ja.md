...
本稿では、Scala 3 の差分コンパイルと、関連する問題についてみていく。Scala 2.12 と 2.13 の差分はある程度安定していると思うが、僕の使っている感覚だと Scala 3 は壊れやすい気がする。この原因を調査して、修正案を [scala/scala3#24171][24171] として送ろうと思う。
