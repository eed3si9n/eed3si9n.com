...
See <https://github.com/sbt/sbt/releases/tag/v2.0.0-RC12>
...
This mechanism allows that sbt 2.0.0-RC12 is used only for the builds that you want.

### 🐛 Bug fixes

* fix: Fixes `.previous` expansion for unstable path by [@tanishiking][@tanishiking] in [#9041](https://github.com/sbt/sbt/pull/9041)
* fix: Fixes test when dependencyMode is set by [@eureka0928][@eureka0928] in [#8990](https://github.com/sbt/sbt/pull/8990)
* fix: Fixes stack traces suppressed in batch mode by [@bittoby][@bittoby] in [#9058](https://github.com/sbt/sbt/pull/9058)

See <https://github.com/sbt/sbt/releases/tag/v2.0.0-RC12> for the full details.

### Other updates

* Adds no-op `addDependencyTreePlugin` shim for migration by [@mkurz][@mkurz] in [#9067](https://github.com/sbt/sbt/pull/9067)
