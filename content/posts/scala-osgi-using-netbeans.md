...
Install <a href="http://www.rubicode.com/Software/RCEnvironment/">RCEnvironment</a> by copying `RCEnvironment.prefPane` into `/Library/PreferencePanes`. When you open System Preferences, Environment Variables now show up. Set <code>JAVA_HOME</code> and <code>SCALA_HOME</code> to where it makes sense. I have them set to <code>/Library/Java/Home/</code> and <code>/opt/local/share/scala/</code>.
