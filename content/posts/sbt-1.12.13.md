...
* fix: Fixes file permissions by [@eed3si9n][@eed3si9n] + [@xuwei-k][@xuwei-k] in [io#527](https://github.com/sbt/io/pull/527) / [#9350](https://github.com/sbt/sbt/pull/9350)
* fix: Fixes `ArrayIndexOutOfBoundsException` error when Unix domain socket is closed by [@merlinorg][@merlinorg] in [ipcsocket#77](https://github.com/sbt/ipcsocket/pull/77)
...
- [The Scala Center Fundraising Campaign](https://scala-lang.org/blog/2023/09/11/scala-center-fundraising.html)
  ...
  [@merlinorg]: https://github.com/merlinorg
